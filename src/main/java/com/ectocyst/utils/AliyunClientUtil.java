...
import com.ectocyst.constant.AliyunClientConstants;
...
public class AliyunClientUtil {
     ...
     * 阿里云短信单发服务
     * @param phone 电话号码
     * @param participant 参与人员姓名
     * @param name 预约者姓名
     * @param date 时间
     * @param boardroom 会议室名称
     * @return 目标JSON
     * @throws ClientException
     */
    public static SendSmsResponse sendSms(String phone, String participant, String name, String date, String boardroom) throws ClientException {
        /* 设置超时时间 */
        ...
        request.setTemplateCode("SMS_162115493");

        JSONObject smsJSON = new JSONObject();
        smsJSON.put("participant", participant);
        smsJSON.put("name", name);
        smsJSON.put("date", date);
        smsJSON.put("boardroom", boardroom);
    ...
    public static String getUrl(String bucket, String folderName, String fileName) {
        String url = "https://" + bucket + ".oss-cn-beijing.aliyuncs.com/" + folderName + "/" + fileName;
